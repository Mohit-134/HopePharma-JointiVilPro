...
const ThankYou = () => {
  ...
  const totalQuantity = latestQuantity + upsellQuantity;
  ...
  return (
    <div className='bg-[#FFFFF]  min-h-[100vh] h-full w-full p-4 text-center'>
      <div className=' max-w-[900px] mx-auto  flex flex-col items-center justify-center gap-4'>
        <img className='h-[150px]' src="./images/hopepharma.webp" />
        ...
        <div className='flex flex-col items-center text-center'>
          <p className="text-[18px]" >You Will Receive The Order Within <strong>15-18 Business Days.</strong> </p>
          <p className='text-[16px]'>We will do our best to <span className='underline font-extrabold'>deliver before then as well</span></p>
        </div>
        ...
        <div className='gap-0'>
          <p className='text-2xl'>
            For any support to your order, you can contact
          </p>
      ...
      <div className="bg-[#F6FBFF] flex flex-col items-center justify-center  w-full gap-4 py-8 mt-8 sticky top-[100%]">
        ...
        <div className='max-w-[300px] w-full '>
          <ul className='text-[#235272] text-xs flex w-full justify-around '>
            <li className="cursor-pointer" onClick={() => handleOpenModal('terms')} >Terms & Conditions</li>
            <li className="cursor-pointer" onClick={() => handleOpenModal('privacy')}>Privacy Policy</li>
            <li className="cursor-pointer" onClick={() => handleOpenModal('wireless')}>Wireless Policy</li>
          </ul>
        </div>
